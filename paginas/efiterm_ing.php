...
<head>
	...
	<script language="JavaScript" type="text/javascript">
	    ...
	    function showLoading(){
	        ...
	        document.getElementById('txtLoadingEstado').innerHTML = "Please wait...";
							...
							<td colspan="3" height="0px">
								<div id="loading" style="DISPLAY: none; Z-INDEX: 2; LEFT: 35%; OVERFLOW: auto; WIDTH: 400px; HEIGHT: 110px; POSITION: absolute; TOP: 40%;">
									<table width="100%" cellpadding="0" cellspacing="0" height="100%" class="popUP" border="0">
										...
										<tr>
											<td height="15px" align="center" id="txtLoadingEstado" class="Titulo"></td>
										</tr>
										<tr>
											<td height="4px"></td>
										</tr>
											...
											<td width="100%">
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													<tr>
														<td width="150px"></td>
														<td>
															<?php echo $pres->crearBoton("btnCancelar", "Cancel", "button", "style=\"width: 80px\" onclick=\"cancelarRequest();\""); ?>
														</td>
													</tr>
												</table>
											</td>
							...
							<td id="tdEfitermDatos">
								<table cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td>
											<?php
												require "../controles/datos_ing.php";
											?>
										</td>
									</tr>
									<tr>
